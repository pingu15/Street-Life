...
public class SplashScreen {
    ...
    public SplashScreen(Stage stage, MainMenu mainMenu){
        //stage init
        this.stage = stage;
        this.mainMenu = mainMenu;

        //screen with the logo-----------------------------------------------------
        logo = new Image("Scenes/logoScreen.png");
        ...
        //regular scene init-------------------------------------------------------
        regularIV = new ImageView(new Image("Scenes/isp_main.png"));
        ...
        //flicker scene init-------------------------------------------------------
        flickerIV = new ImageView(new Image("Scenes/isp_mainF.png"));
