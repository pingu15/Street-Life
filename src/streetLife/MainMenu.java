...
public class MainMenu implements EventHandler {
	 ...
	 * <li>if any screen's back button is pressed, the scene switches back to the main menu
	 * <li>if the start button is pressed the deficiency room is called
	 * <li>if the instructions button is pressed the instruction page is brought up
	 * <li>if the about button is pressed the about page is brought up
	 * <li>if the credits button is pressed the credit page is brought up
	 * <li>if the exit button is pressed the game exits
	 *
